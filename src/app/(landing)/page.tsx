...
const Page = () => {
  const codeSnippet = `await fetch("https://pingpanda-santi.vercel.app//api/v1/events", {
  method: "POST",
  body: JSON.stringify({
    category: "sale",
    fields: {
      ...
      <section className="relative bg-brand-25 pb-4">
        ...
        <div className="relative mx-auto">
          <MaxWidthWrapper className="relative">
            {/* ring-inset: crea el borde hacia el interior del elemento. Margin negativo es para que siempre matchee el padding, asi el elemento no se mueve*/}
        ...
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-20">
          ...
          <div className="grid gap-4 lg:grid-cols-3 lg:grid-rows-2">
            ...
            <div className="relative lg:row-span-2">
              ...
              {/* en la clase rounded, estamos calculando para que el borde y el espacio que hay entre el padre y el hijo sean iguales (para que no queden distintos en las esquinas basicamente)*/}
              <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] lg:rounded-l-[calc(2rem+1px)]">
                <div className="px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10">
                  {/* max-lg: se aplica en los tamaños antes de lg*/}
                ...
                <div className="relative min-h-[30rem] w-full grow [container-type:inline-size] max-lg:mx-auto max-lg:max-w-sm">
                  {/*cqw: container query width, nos permite estilizar el border-radius de acuerdo al padre que tiene que tener la clase container-type:inline-size*/}
